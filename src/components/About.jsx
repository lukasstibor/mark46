...
export default function About() {
  return (
    <section id="about" className="py-20 px-6 border-t border-[#111]">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Mobile: stacked — photo full width → links → bio. Desktop: 5-col grid */}
        <div className="lg:grid lg:grid-cols-5 lg:gap-16 lg:items-start">
          ...
          >
            {/* ── Mobile layout: photo full width, then name/tags/links below ── */}
            <div className="lg:hidden mb-8">
              {/* Photo */}
              <div className="relative overflow-hidden border border-[#1e1e1e] mb-5" style={{ width: '160px', height: '160px' }}>
                <div className="absolute top-0 left-0 w-4 h-4 border-t-[1.5px] border-l-[1.5px] border-[#B22222]/50 z-10" />
                <div className="absolute top-0 right-0 w-4 h-4 border-t-[1.5px] border-r-[1.5px] border-[#B22222]/50 z-10" />
                <div className="absolute bottom-0 left-0 w-4 h-4 border-b-[1.5px] border-l-[1.5px] border-[#B22222]/50 z-10" />
                <div className="absolute bottom-0 right-0 w-4 h-4 border-b-[1.5px] border-r-[1.5px] border-[#B22222]/50 z-10" />
                <img
                  src="/lukas-photo.jpeg"
                  alt="Lukas Stibor"
                  className="w-full h-full object-cover"
              ...
              {/* Name & title */}
              <h2 className="font-display font-bold text-[1.5rem] text-[#f0ede8] mb-1 tracking-tight">
                Lukas Stibor
              </h2>
              <p className="font-mono text-[10px] text-[#666] tracking-[0.18em] mb-4">
                CEO · CLEEVIO GROUP
              </p>
              ...
              <div className="flex flex-wrap gap-1.5 mb-4">
                {TAGS.map((tag) => (
                  <span
                    key={tag}
                    className="font-mono text-[9px] text-[#666] border border-[#1e1e1e] px-2 py-1 tracking-wide"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <div className="flex items-center gap-2">
                <a
                  ...
                  className="flex items-center gap-1.5 border border-[#1e1e1e] px-2.5 py-2 text-[#666] hover:text-[#f0ede8] hover:border-[#333] transition-all duration-200"
                >
                  <TwitterIcon />
            ...
            <div className="hidden lg:block">
              ...
              <p className="font-mono text-[11px] text-[#666] tracking-[0.2em] mb-5">
                CEO · CLEEVIO GROUP
              </p>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {TAGS.map((tag) => (
                  <span
                    key={tag}
                    className="font-mono text-[10px] text-[#666] border border-[#1e1e1e] px-3 py-1.5 tracking-wide hover:border-[#2e2e2e] hover:text-[#999] transition-all duration-200"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center gap-2 border border-[#1e1e1e] px-3.5 py-2.5 text-[#666] hover:text-[#f0ede8] hover:border-[#333] transition-all duration-200"
                >
                  <TwitterIcon />
          ...
          <motion.div
            ...
            className="lg:col-span-3 space-y-5 pt-0 lg:pt-2"
          >
            <p className="text-[#a09a90] text-[1rem] leading-[1.8]">
              I've been a tech entrepreneur since I built my first website at 14 and have founded
              and scaled several companies across gaming, fintech, and AI.
            </p>

            <p className="text-[#a09a90] text-[1rem] leading-[1.8]">
              From 2008 to 2017, I was Co-founder &amp; CEO of Cleevio, a digital product studio
              working with global brands like McDonald's, Coca-Cola, and Oreo. I also co-founded
              GAMEE (acquired by Animoca Brands) — a gaming platform with 8M+ monthly users and
              partnerships with Facebook, Telegram, Manchester City, and NASA — and Spendee,
              the award-winning personal finance app helping millions manage their money smarter.
            </p>

            <p className="text-[#a09a90] text-[1rem] leading-[1.8]">
              After leaving Cleevio I spent several years exploring crypto and Web3, which led to
              CleevioX, our blockchain development studio. In 2020 I returned to help with sales —
              we grew over 400% in the first year, reaching $8M+ in revenue and earning recognition
              in the Deloitte Tech Fast 50 &amp; 500.
            </p>

            <p className="text-[#a09a90] text-[1rem] leading-[1.8]">
              In 2025 I came back full-time as CEO of Cleevio Group, focusing on strategy, growth,
              and transforming the company into an AI-first organization. We're combining 15 years
              of product experience with the power of AI to help clients and partners build what's next.
            </p>
            ...
            <div className="pt-3 grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              >
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <span className="font-mono text-[10px] text-[#555] group-hover/card:text-[#B22222] tracking-widest uppercase transition-colors duration-300">Open to invest</span>
                </div>
              ...
              >
                <div className="flex items-center gap-2 mb-1.5">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#333] group-hover/card:bg-[#B22222] transition-colors duration-300" />
                  <span className="font-mono text-[10px] text-[#555] group-hover/card:text-[#B22222] tracking-widest uppercase transition-colors duration-300">Consulting</span>
                </div>
                <p className="text-[#666] text-[0.8rem] leading-relaxed">
